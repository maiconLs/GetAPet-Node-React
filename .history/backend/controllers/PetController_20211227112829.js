import Pet, { find, findOne, findByIdAndRemove, findByIdAndUpdate } from '../models/Pet.js'
...
export default class PetController{
  ...
  static async getAll(req, res)  {
    const pets = await find().sort('-createdAt')
  ...
  static async getAllUserPets(req, res) {
    ...
    const pets = await find({ 'user._id': user._id }).sort('-createdAt')
  ...
  static async getAllUserAdoptions(req, res) {
    ...
    const pets = await find({ 'adopter._id': user._id })
